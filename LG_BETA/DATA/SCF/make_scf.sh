...
#5 -increasing but fixed Q in two directions and additional electrons using relaxed lattice from #2 (2Q unstrained doped)
#6 -increasing but fixed P in one direction and relaxed lattice (P unstrained)
#7 -increasing but fixed P in one and Q in one direction and relaxed lattice (PQ unstrained)
...
#10 -increasing but fixed P in one and Q in one direction and relaxed lattice and additional electrons using relaxe lattice from #9 (PQ unstrained doped)
